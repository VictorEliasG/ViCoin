...
import { idlFactory } from './token_frontend.did.js';
export { idlFactory } from './token_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TOKEN_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_frontend.did.js")._SERVICE>}
 */
export const token_frontend = createActor(canisterId);
